...
import memorystrategy.MemoryStrategy;
import memorystrategy.MemoryStrategyFactory;
import space.Space;
import space.SpaceFactory;
import tooltip.ToolTipManager;
import tooltip.ToolTipManagerFragmentationImpl;
...
public class ManagementFragmentationImpl extends ManagementAbstract implements ManagementFragmentation {
    ...
    private static ManagementFragmentation instance;
	...
	public static ManagementFragmentation getInstance() {
		if (instance == null) {
			instance = new ManagementFragmentationImpl();
		}
		return instance;
	}
