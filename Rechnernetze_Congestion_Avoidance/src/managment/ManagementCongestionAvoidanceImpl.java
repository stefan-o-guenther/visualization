...
import management.ManagementCoordinateSystemAbstract;
import point.Point;
import point.PointImpl;
import tooltip.ToolTipManager;
import tooltip.ToolTipManagerCongestionAvoidanceImpl;
...
public class ManagementCongestionAvoidanceImpl extends ManagementCoordinateSystemAbstract implements ManagementCongestionAvoidance {
	...
	private static ManagementCongestionAvoidance instance;
    ...
    public static ManagementCongestionAvoidance getInstance() {
		if (instance == null) {
			instance = new ManagementCongestionAvoidanceImpl();
		}
		return instance;
	}	
