...
import management.ManagementGeometryAbstract;
...
import arqprotocolstrategy.ARQProtocolStrategy;
import arqprotocolstrategy.ARQProtocolStrategyFactory;
import ToolTip.ToolTipManagerARQImpl;
...
public class ManagementAutomaticRepeatRequestImpl extends ManagementGeometryAbstract implements ManagementAutomaticRepeatRequest {
	...
	private static ManagementAutomaticRepeatRequest instance;
	
    private ManagementAutomaticRepeatRequestImpl() {
    	super();
    }
    
    public static ManagementAutomaticRepeatRequest getInstance() {
		if (instance == null) {
			instance = new ManagementAutomaticRepeatRequestImpl();
		}
		return instance;
	}	
