...
import Packet.PacketQalBlueImpl;
import Packet.PacketQalCyanImpl;
import Packet.PacketQalGreenImpl;
import Packet.PacketQalMagentaImpl;
import Packet.PacketQalOrangeImpl;
import Packet.PacketQalPinkImpl;
import Packet.PacketQalRedImpl;
import Packet.PacketQalYellowImpl;
...
public class ManagementQueueingAndLossImpl extends ManagementAbstract implements ManagementQueueingAndLoss {
	...
	private static ManagementQueueingAndLoss instance;
	
    private ManagementQueueingAndLossImpl() {
    	super();
    }
    
    public static ManagementQueueingAndLoss getInstance() {
		if (instance == null) {
			instance = new ManagementQueueingAndLossImpl();
		}
		return instance;
	}	
